...
echo
echo
toilet -f future "    Tebas Index" | lolcat
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo $yellow
figlet -f future "004 Eror Syestem"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"@Root(Mr.004)"$cyan" ~/IndoCyber"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"@Root(Mr.004)"$cyan" ~/IndoCyber"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan nama Script!!! "
echo $green "╭─"$blue"@Root(Mr.004)"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"@Mr.004"$cyan" ~/IndoCyber"$white                               
read -p " ╰─$ " script
echo
echo
echo $white"Masukan Target1 !!!!"
echo $white "╭─"$green"@Mr.004"$cyan" ~/Crot"$white
read -p " ╰─$ " target1
...
echo $white "╭─"$green"Chemod@zrd"$cyan" ~/Crot"$white
read -p " ╰─$ " target20
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author  : Mr.004 Feat Hat_12			"
echo $purple"Gthub   : https://github.com/Mr.004-Tols"
echo $white"Blog    : http://resc.blogspot.com"
echo
echo $yellow"                          THANKS TO :"
echo
echo $cyan"[+] MR.H3RD & Conor9k "
echo $cyan"[+] MR.Gary "
echo $cyan"[+] Hat_12 & All Member [004] "
echo $red"##########################$green" WELCOME "$red###########################"
